...
description: 产品监控预警体系自动构建。根据产品架构和业务需求，自动生成监控指标、告警规则和 On-Call 手册。关键词：监控系统、监控配置、健康检查、告警规则、监控体系。
metadata:
  module: "产品监控与迭代"
  sub-module: "监控预警"
  type: "pipeline"
...
| 指标体系 | JSON | 是 | metrics-system → metric_system | 需监控的业务指标和技术指标定义 |
...
```
output/pm-monitoring/monitoring-system/
