---
name: tracking-plan
description: 埋点方案自动生成。包含从指标体系反推埋点需求、PRD功能埋点提取、埋点质量检查、PRD一致性校验。关键词：埋点方案、事件设计、属性设计、埋点规范、Tracking Plan、数据采集。
metadata:
  module: "产品度量设计"
  sub-module: "埋点方案"
  type: "pipeline"
...
| 指标体系 | JSON | 是 | metrics-system → metric_system | 北极星指标、L1/L2/行动指标 |
