...
输出: output/pm-design/validation-experiment/experiment_plan.json
...
输入:
  ...
  experiment_method: output/pm-design/validation-experiment/experiment_plan.json（可选，当方法=可用性测试时）
