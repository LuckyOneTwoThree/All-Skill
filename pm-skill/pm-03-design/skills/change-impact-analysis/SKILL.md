...
description: 当PRD或设计发生变更时使用。变更影响自动分析，分析需求变更对功能、技术、测试等维度的影响范围，生成变更影响报告和重评审建议。关键词：变更影响、需求变更、影响分析、变更评审、PRD变更。
metadata:
  module: "产品构思与设计"
  sub-module: "设计评审"
  type: "pipeline"
...
**存储路径**：`output/pm-design/change-impact-analysis/`
...
| API契约缺失 | 仅评估对前端和设计的影响 | 后端影响可能被低估 |
| 后端审查报告缺失 | 仅基于PRD和设计评估 | 后端架构风险可能被遗漏 |
