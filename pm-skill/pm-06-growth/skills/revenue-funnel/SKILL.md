...
1. **付费是价值确认不是障碍**：付费墙的时机和方式应该让用户觉得"值得付费"而非"被迫付费"
2. **障碍类型决定优化方向**：认知/价格/信任/需求/时机五类障碍需要完全不同的优化策略
3. **付费墙时机即转化率**：同一产品在不同付费墙时机下转化率可能差3倍
...
| 上游来源 | 变更类型 | 影响范围 | 响应动作 |
|----------|----------|----------|----------|
| revenue-nrr | NRR数据更新 | 付费转化趋势和漏斗对比 | 更新转化率基准和趋势分析 |
| 用户提供-全链路数据 | 数据口径变更 | 漏斗计算和障碍识别 | 按新口径重新计算漏斗 |
| 用户提供-用户特征 | 分群维度变更 | 多维度拆分分析 | 按新维度重新拆分漏斗 |

### 下游通知机制表

| 下游消费者 | 通知条件 | 通知方式 | 通知内容 |
|------------|----------|----------|----------|
| revenue-upsell | 付费墙时机变更 | 写入输出文件 | 新的付费墙时机和试用策略 |
| revenue-orchestrator | 付费漏斗分析完成 | 输出文件更新 | 漏斗分析完成状态和关键结论 |
