...
|--------------|-------------------------------|-------------|
| PRD | pm-design related orchestrator | PRD is the business basis for revenue-orchestrator, missing will result in execution without business foundation |
| Sub-skill outputs | Sub-skill execution | Sub-skills (revenue-upsell, revenue-funnel, revenue-nrr...) produce domain-specific outputs |
