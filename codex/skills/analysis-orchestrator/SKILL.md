...
|--------------|-------------------------------|-------------|
| PRD | pm-design related orchestrator | PRD is the business basis for analysis-orchestrator, missing will result in execution without business foundation |
| Sub-skill outputs | Sub-skill execution | Sub-skills (analysis-funnel, analysis-anomaly, analysis-retention...) produce domain-specific outputs |
