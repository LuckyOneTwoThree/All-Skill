...
|--------------|-------------------------------|-------------|
| PRD | pm-design related orchestrator | PRD is the business basis for activation-orchestrator, missing will result in execution without business foundation |
| Sub-skill outputs | Sub-skill execution | Sub-skills (activation-aha, activation-onboarding...) produce domain-specific outputs |
